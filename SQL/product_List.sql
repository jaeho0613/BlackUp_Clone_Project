...
insert into colorset values(1, '차콜','#474747');
...
insert into colorset values(2,'민트','#BCD1B2');
insert into colorset values(2,'네이비','#1E3E57');
...
insert into colorset values(3,'그레이','#A9A9A9');
insert into colorset values(3,'베이지','#BFB4A0');
...
insert into colorset values(4,'딥그린','#34664B');
insert into colorset values(4,'아이보리','#F2F0E1');
insert into colorset values(4,'옐로우','#D6C880');
...
insert into colorset values(5,'그레이','#A9A9A9');
insert into colorset values(5,'그린','#48915F');
...
insert into colorset values(6,'네이비','#1E3E57');
insert into colorset values(6,'베이지','#BFB4A0');
insert into colorset values(6,'오트밀','#E6E3D1');
insert into colorset values(6,'아이보리','#F2F0E1');
...
insert into colorset values(7,'블루','#2B3D99');
insert into colorset values(7,'그린','#48915F');
...
insert into colorset values(9,'네이비','#1E3E57');
insert into colorset values(9,'베이지','#BFB4A0');
insert into colorset values(9,'오트밀','#E6E3D1');
insert into colorset values(9,'아이보리','#F2F0E1');
...
insert into colorset  values(10,'네이비','#1E3E57');
insert into colorset  values(10,'베이지','#BFB4A0');
insert into colorset  values(10,'오트밀','#E6E3D1');
insert into colorset  values(10,'아이보리','#F2F0E1');
...
insert into colorset  values(11,'네이비',' #1E3E57');
insert into colorset  values(11,'베이지','#BFB4A0');
insert into colorset  values(11,'오트밀','#E6E3D1');
insert into colorset  values(11,'아이보리','#F2F0E1');
...
insert into colorset  values(12,'네이비','#1E3E57');
insert into colorset  values(12,'베이지','#BFB4A0');
insert into colorset  values(12,'오트밀','#E6E3D1');
insert into colorset  values(12,'아이보리','#F2F0E1');
...
insert into colorset  values(13,'네이비','#1E3E57');
insert into colorset  values(13,'베이지','#BFB4A0');
insert into colorset  values(13,'오트밀','#E6E3D1');
insert into colorset  values(13,'아이보리','#F2F0E1');
