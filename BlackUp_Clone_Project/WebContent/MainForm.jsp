		...
		<div class="card-group">
			...
			<div class="card border-0">
				...
				<div class="card-body">
					...
					<div class="colors d-flex align-items-center justify-content-center mt-1">
						<span class="border border-dark" style="background-color: #4BAB6D;"></span> <span class="border border-dark"
			...
			<div class="card border-0">
				...
				<div class="card-body">
					...
					<!-- 컬러 셋 -->
					<div class="colors d-flex align-items-center justify-content-center mt-1">
						<span class="border border-dark" style="background-color: #FEFFEF;"></span> <span class="border border-dark"
							style="background-color: #C4BDB0;"></span>
						<span class="border border-dark" style="background-color: #ADA48A;"></span> <span class="border border-dark"
							style="background-color: #474C70;"></span>
						<span class="border border-dark" style="background-color: #000000;"></span>
					</div>
				</div>
			</div>
			...
			<div class="card border-0">
				...
				<div class="card-body">
					...
					<!-- 컬러 셋 -->
					<div class="colors d-flex align-items-center justify-content-center mt-1">
						<span class="border border-dark" style="background-color: #007543;"></span> <span class="border border-dark"
							style="background-color: #0000FD;"></span>
						<span class="border border-dark" style="background-color: #000000;"></span>
					</div>
				</div>
			</div>
		...
		<div class="card-group">
			...
			<div class="card border-0">
				...
				<div class="card-body">
					...
					<!-- 컬러 셋 -->
					<div class="colors d-flex align-items-center justify-content-center mt-1">
						<span class="border border-dark" style="background-color: #FFFFFF;"></span> <span class="border border-dark"
							style="background-color: #EBDCC5;"></span>
						<span class="border border-dark" style="background-color: #A9A9A9;"></span> <span class="border border-dark"
			...
			<div class="card border-0">
				...
				<div class="card-body">
					...
					<!-- 컬러 셋 -->
					<div class="colors d-flex align-items-center justify-content-center mt-1">
						<span class="border border-dark" style="background-color: #EBE7D6;"></span> <span class="border border-dark"
							style="background-color: #787878;"></span>
						<span class="border border-dark" style="background-color: #000000;"></span>
					</div>
				</div>
			</div>
		...
		<div class="card-group">
			...
			<div class="card border-0">
				...
				<div class="card-body">
					...
					<div class="colors d-flex align-items-center justify-content-center mt-1">
						<span class="border border-dark" style="background-color: #FEFFEF;"></span> <span class="border border-dark"
							style="background-color: #B0B566;"></span>
						<span class="border border-dark" style="background-color: #A2BDB6;"></span> <span class="border border-dark"
							style="background-color: #93A5B8;"></span>
						<span class="border border-dark" style="background-color: #6E6E6E;"></span> <span class="border border-dark"
							style="background-color: #000000;"></span>
					</div>
				</div>
			</div>
			...
			<div class="card border-0">
				...
				<div class="card-body">
					...
					<!-- 컬러 셋 -->
					<div class="colors d-flex align-items-center justify-content-center mt-1">
						<span class="border border-dark" style="background-color: #F5F5F5;"></span> <span class="border border-dark"
							style="background-color: #C2C2C2;"></span>
						<span class="border border-dark" style="background-color: #474747;"></span> <span class="border border-dark"
							style="background-color: #000000;"></span>
					</div>
				</div>
			</div>
			...
			<div class="card border-0">
				...
				<div class="card-body">
					...
					<!-- 컬러 셋 -->
					<div class="colors d-flex align-items-center justify-content-center mt-1">
						<span class="border border-dark" style="background-color: ##FEFFEF;"></span> <span
							class="border border-dark" style="background-color: #000000;"></span>
					</div>
				</div>
			</div>
		</div>
