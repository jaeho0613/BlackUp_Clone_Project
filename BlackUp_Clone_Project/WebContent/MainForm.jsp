...
<body>
		...
		<div id="carouselExampleIndicators" class="carousel slide"
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img
						src="https://black-up.kr/web/upload/yangji_pc_crumb/210224-madesale-PCmain.jpg"
						class="d-block w-100" alt="main_img" />
				</div>
				<div class="carousel-item">
					<img src="${imagepath.pdID}" class="d-block w-100" alt="main_img" />
				</div>
				<div class="carousel-item">
					<img src="${imagepath.pdID}" class="d-block w-100" alt="main_img" />
				</div>
				<div class="carousel-item">
					<img
						src="https://black-up.kr/web/upload/yangji_pc_crumb/210226-main02.jpg"
						class="d-block w-100" alt="main_img" />
				</div>
				<div class="carousel-item">
					<img
						src="https://black-up.kr/web/upload/yangji_pc_crumb/210226-main01.jpg"
						class="d-block w-100" alt="main_img" />
				</div>
			</div>
	...
	<section class="container" id="top_item">
		...
		<div class="card-group">
			<div class="card">
				<img
					src="https://black-up.kr/web/product/medium/202102/024bcd8a020081fe5b9cb15f5e62f406.webp"
					class="card-img-top" alt="...">
			</div>
			<div class="card">
				<img
					src="https://black-up.kr/web/product/medium/202102/a77678c22239dc4c5ce0ed9b0f855e2a.webp"
					class="card-img-top" alt="...">
			</div>
			<div class="card">
				<img
					src="https://black-up.kr/web/product/medium/202102/8774b3b2922f80e733d94f56be5c5f11.webp"
					class="card-img-top" alt="...">
			</div>
			<div class="card">
				<img
					src="https://black-up.kr/web/product/medium/202102/fc25c3e891cad5d6649b7e1788d56f5d.webp"
					class="card-img-top" alt="...">
			</div>
		</div>
	</section>
	...
	<div class="card-group">
		...
		<div class="card border-0">
			...
			<div class="card-body">
				...
				<!-- 컬러 셋 -->
				<div
					class="colors d-flex align-items-center justify-content-center mt-1"></div>
			</div>
		</div>
		<!-- 의상 -->
		<div class="card border-0">
