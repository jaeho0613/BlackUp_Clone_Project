...
<body>
  ...
  <section class="container" id="made_item">
    <h2 class="product-title text-start">Made Product</h2>
    <!-- 그룹 1 -->
  ...
  <!-- Outer 이미지 그리드 섹션 -->
  <section class="container" id="outer_item">
    <h2 class="product-title text-start">Outer Product</h2>
    <!-- 그룹 1 -->
    <div class="card-group">
      <div class="card">
  ...
  <section class="container" id="Pants_item">
    <h2 class="product-title text-start">Pants Product</h2>
    <!-- 그룹 -->
    <div class="card-group">
      <!-- 의상 -->
