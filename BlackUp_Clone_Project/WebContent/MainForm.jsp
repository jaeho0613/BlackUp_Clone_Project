      ...
      >
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img
              src="https://black-up.kr/web/upload/yangji_pc_crumb/210305-main01.jpg"
              class="d-block w-100"
              alt="main_img"
            />
          </div>
          <div class="carousel-item">
            <img
              src="https://black-up.kr/web/upload/yangji_pc_crumb/210305-main02.jpg"
              class="d-block w-100"
              alt="main_img"
            />
          </div>
          <div class="carousel-item">
            <img
              src="https://black-up.kr/web/upload/yangji_pc_crumb/210305-main03.jpg"
              class="d-block w-100"
              alt="main_img"
            />
          </div>
          <div class="carousel-item">
            <img
              src="https://black-up.kr/web/upload/yangji_pc_crumb/210305-main04.jpg"
              class="d-block w-100"
              alt="main_img"
            />
          </div>
    ...
    <section class="container" id="made_item">
      ...
      <c:forEach begin="0" end="${ num }" varStatus="vs">
        <div class="card-group">
          <c:forEach
            begin="${ vs.index + (vs.index * 3) }"
            end="${ (vs.index + (vs.index * 3)) + 3 }"
            items="${ madeList }"
            var="product"
          >
            <div class="card">
              <a href="/BlackUp_Clone_Project/product?pdID=${ product.pdID }">
                <img
                  src="${ product.imagePathList[0].imgPath }"
                  class="card-img-top"
                  alt="..."
                />
              </a>
          ...
          >
            ...
            <div class="card border-0">
              <a href="/BlackUp_Clone_Project/product?pdID=${ pants.pdID }">
                <img
                  src="${ pants.imagePathList[0].imgPath }"
                  class="card-img-top"
                  alt="..."
                />
              </a>
          ...
          >
            ...
            <div class="card border-0">
              <a href="/BlackUp_Clone_Project/product?pdID=${ outer.pdID }">
                <img
                  src="${ outer.imagePathList[0].imgPath }"
                  class="card-img-top"
                  alt="..."
                />
              </a>
