	...
	<section>
		<div>
			<ul class="nav justify-content-center">
				...
				<li class="nav-item"><a class="nav-link" href="#" style="color: #000000">하의</a></li>
				<li class="nav-item"><a class="nav-link" href="#" style="color: #000000">기타</a></li>
			</ul>
		</div>

		<ul class="nav justify-content-end">
			<li class="nav-item"><a class="nav-link" href="#" style="color: #000000">NEW</a></li>
			<li class="nav-item"><a class="nav-link" href="#" style="color: #000000">BEST</a></li>
			<li class="nav-item"><a class="nav-link" href="#" style="color: #000000">NAME</a></li>
			<li class="nav-item"><a class="nav-link" href="#" style="color: #000000">LOW PRICE</a></li>
			<li class="nav-item"><a class="nav-link" href="#" style="color: #000000">HIGH PRICE</a></li>
		</ul>
	</section>
	<!-- 오늘의 새로운 아이템 섹션 -->
		...
		<div class="card-group">
			...
			<div class="card border-0">
				...
				<div class="card-body">
					...
					<!-- 컬러 셋 -->
					<div class="colors d-flex align-items-center justify-content-center mt-1">
						<span class="border border-light" style="background-color: #feffef"></span> <span
							class="border border-light" style="background-color: #c4bdb0"></span>
						<span class="border border-light" style="background-color: #ada48a"></span> <span
							class="border border-light" style="background-color: #474c70"></span>
						<span class="border border-light" style="background-color: #000000"></span>
					</div>
				</div>
			</div>
			...
			<div class="card border-0">
				...
				<div class="card-body">
					...
					<!-- 컬러 셋 -->
					<div class="colors d-flex align-items-center justify-content-center mt-1">
						<span class="border border-light" style="background-color: #007543"></span> <span
							class="border border-light" style="background-color: #0000fd"></span>
						<span class="border border-light" style="background-color: #000000"></span>
					</div>
				</div>
			</div>
		...
		<div class="card-group">
			...
			<div class="card border-0">
				...
				<div class="card-body">
					...
					<!-- 컬러 셋 -->
					<div class="colors d-flex align-items-center justify-content-center mt-1"></div>
				</div>
			</div>
			<!-- 의상 -->
			<div class="card border-0">
				...
				<div class="card-body">
					...
					<!-- 컬러 셋 -->
					<div class="colors d-flex align-items-center justify-content-center mt-1">
						<span class="border border-light" style="background-color: #ffffff"></span> <span
							class="border border-light" style="background-color: #ebdcc5"></span>
						<span class="border border-light" style="background-color: #a9a9a9"></span> <span
							class="border border-light" style="background-color: #000000"></span>
					</div>
				</div>
			</div>
			<!-- 의상 -->
			<div class="card border-0">
				...
				<div class="card-body">
					...
					<!-- 컬러 셋 -->
					<div class="colors d-flex align-items-center justify-content-center mt-1">
						<span class="border border-light" style="background-color: #ebe7d6"></span> <span
							class="border border-light" style="background-color: #787878"></span>
						<span class="border border-light" style="background-color: #000000"></span>
					</div>
				</div>
			</div>
