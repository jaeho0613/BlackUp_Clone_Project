...
<nav class="navbar navbar-expand-lg navbar-light fixed-top m-3">
	<div class="container-fluid">
		...
		<a class="navbar-brand" href="/BlackUp_Clone_Project/MainForm.jsp">
			<img
			src="https://black-up.kr/web/upload/yangji_pc_crumb/main_logo.png"
			alt="#">
		</a>
		<!-- Toggler button-->
		...
		<div class="collapse navbar-collapse justify-content-between"
			...
			<ul class="navbar-nav mb-2 mb-lg-0">
				...
				<li class="nav-item"><a class="nav-link active"
					aria-current="page" href="#">BEST50</a></li>
				<!-- new -->
				<li class="nav-item"><a class="nav-link active"
					aria-current="page" href="#">NEW</a></li>
				<!-- top -->
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-bs-toggle="dropdown" aria-expanded="false">TOP
				</a>
				...
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-bs-toggle="dropdown" aria-expanded="false">PANTS
				</a>
					<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
				...
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-bs-toggle="dropdown" aria-expanded="false">ACC
				</a>
					<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
